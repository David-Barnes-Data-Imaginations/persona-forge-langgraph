...
export default function CopilotKitPage() {
  ...
  useCopilotAction({
    ...
    handler: async ({ query }) => {
      try {
        ...
        const response = await fetch("http://localhost:8001/visualize", {
          method: "POST",
  ...
  useCopilotAction({
    ...
    handler: async ({ query }) => {
      try {
        const response = await fetch("http://localhost:8001/circumplex", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
            data_type: "emotions",
  ...
  useCopilotAction({
    ...
    handler: async () => {
      try {
        ...
        const response = await fetch("http://localhost:8001/read-therapy-note", {
          method: "GET",
          headers: { "Content-Type": "application/json" },
        });
